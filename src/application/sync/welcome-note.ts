...
export function buildWelcomeNote(syncFolder: string, pagesSynced: number): string {
  ...
  return [
    ...
    '',
    '## Before you go further, one thing to know',
    '',
    'N2O Sync Lite is no longer being developed. It and N2O Sync Pro carry separate',
    'copies of the same sync engine, we are a very small team, and Lite is the copy',
    'that does not get the fixes. Notion changes its API without warning, and when',
    'that breaks Lite we cannot say when it will be repaired.',
    '',
    'N2O Sync Pro is the one we keep alive. Its free tier is the same 100 pages and',
    'the same one direction you have here, so switching costs you nothing, and the',
    '14-day trial opens the whole thing up first.',
    '',
    ...
    'panel or from Settings. When it ends you are not locked out: N2O Sync Pro falls',
    'back to a free tier of 100 pages, pull only, which is exactly what you have',
    'here. Nothing is ever removed from your vault.',
    '',
    '---',
    '',
